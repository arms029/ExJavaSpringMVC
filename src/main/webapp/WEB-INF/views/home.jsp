...
<link href="${contextPath}resources/css/book-collection.css" rel="stylesheet" type="text/css" media="all" />
	...
	<h1>Novidades da casa do código</h1>
		...
		<ul class="clearfix book-collection">
			...
			<c:forEach items="${produtos}" var="produto">
				<li>
					...
					<small class="buy-button"><s:message code="body.buy"/></small>
					</a>
				</li>
			</c:forEach>
		...
		<h2 class="cdc-call"><s:message code="body.dif"/></h2>

		<ul id="cdc-diferenciais" class="clearfix">
			<li class="col-left">
				<h3><s:message code="body.freeEbooks"/></h3>
				<p>
